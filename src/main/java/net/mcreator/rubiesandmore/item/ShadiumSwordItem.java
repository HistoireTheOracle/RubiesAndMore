...
public class ShadiumSwordItem extends RubiesAndMoreModElements.ModElement {
	@ObjectHolder("rubies_and_more:shadium_sword")
	public static final Item block = null;
	public ShadiumSwordItem(RubiesAndMoreModElements instance) {
		super(instance, 36);
	}
