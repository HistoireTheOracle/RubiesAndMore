...
public class ShadiumAxeItem extends RubiesAndMoreModElements.ModElement {
	@ObjectHolder("rubies_and_more:shadium_axe")
	public static final Item block = null;
	public ShadiumAxeItem(RubiesAndMoreModElements instance) {
		super(instance, 35);
	}
