...
public class RubyOreBlock extends RubiesAndMoreModElements.ModElement {
	@ObjectHolder("rubies_and_more:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(RubiesAndMoreModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("rubies_and_more:ruby_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rubies_and_more:ruby_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
