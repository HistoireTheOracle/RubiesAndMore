...
public class RubyBlockBlock extends RubiesAndMoreModElements.ModElement {
	@ObjectHolder("rubies_and_more:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(RubiesAndMoreModElements instance) {
		super(instance, 3);
	}
