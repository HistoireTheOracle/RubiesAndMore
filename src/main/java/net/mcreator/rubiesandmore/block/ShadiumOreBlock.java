...
import net.mcreator.rubiesandmore.item.ShadiumIngotItem;
...
public class ShadiumOreBlock extends RubiesAndMoreModElements.ModElement {
	@ObjectHolder("rubies_and_more:shadium_ore")
	public static final Block block = null;
	public ShadiumOreBlock(RubiesAndMoreModElements instance) {
		super(instance, 29);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ShadiumIngotItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("rubies_and_more:shadium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("shadium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("rubies_and_more:shadium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
