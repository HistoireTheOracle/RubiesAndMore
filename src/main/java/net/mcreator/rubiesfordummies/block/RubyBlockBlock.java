...
public class RubyBlockBlock extends RubiesForDummiesModElements.ModElement {
	@ObjectHolder("rubies_for_dummies:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(RubiesForDummiesModElements instance) {
		super(instance, 3);
	}
